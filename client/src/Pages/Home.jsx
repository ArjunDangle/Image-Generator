...
const RenderCards = ({ data, title, onDelete }) => {
  if (data?.length > 0) {
    return data.map((post) => (
      <Card key={post._id} {...post} onDelete={onDelete} />
    ));
  }
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        Explore a gallery of stunning and creative images, proudly generated by the community using Stability AI models on Hugging Face.
        </p>
      </div>
